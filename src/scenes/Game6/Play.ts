...
export default class Game6PlayScene extends Phaser.Scene {
  ...
  private createBalls(): void {
    ...
    phoneticSymbols.forEach((v, i) => {
      ...
      //let ballText = new Phaser.GameObjects.Text(this, 1024 * 0.5 + 10, 410+5, v.name, { align: "center", fontSize: "47px" ,fontFamily:"Arial Rounded MT Bold",stroke:"#fff",strokeThickness:2}).setOrigin(0.5);
      let ballText = new Phaser.GameObjects.Text(this,initPosition.x,initPosition.y+18, v.name, { align: "center", fontSize: "47px" ,fontFamily:"Arial Rounded MT Bold",stroke:"#fff",strokeThickness:2}).setOrigin(0.5);
      /**
       * init work
       */
