...
export default class ButtonExit extends Button {
    ...
    constructor(scene: Phaser.Scene, x: number = 25 + 60 * 0.5, y:number = 25 + 60 * 0.5,texture: string = "btn_exit", shape: any = new Phaser.Geom.Circle(60 * 0.5, 60 * 0.5, 60), callback: Phaser.Types.Input.HitAreaCallback = Phaser.Geom.Circle.Contains) {
