...
export class Gold extends Phaser.GameObjects.Container{
    ...
    constructor(scene:Phaser.Scene,value:number|string){
        ...
        this.goldText = new Phaser.GameObjects.Text(scene,10,11,value, <Phaser.Types.GameObjects.Text.TextStyle>{ align: "center", fontSize: `8px`, fontFamily: "Arial", stroke: "#000", strokeThickness: 0 }).setOrigin(0.5).setResolution(2);
