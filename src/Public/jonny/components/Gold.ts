...
export class Gold extends Phaser.GameObjects.Container{
    ...
    constructor(scene:Phaser.Scene,value:number|string){
        ...
        this.goldText = new Phaser.GameObjects.Text(scene,12.5,17.7,value, <Phaser.Types.GameObjects.Text.TextStyle>{ align: "center", fontSize: `16px`, fontFamily: "Arial", stroke: "#000", strokeThickness: 0 }).setOrigin(0.5).setResolution(2);
