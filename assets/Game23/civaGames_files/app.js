...
/***/ "./src/Public/TipsParticlesEmitter.ts":
/*!********************************************!*\
  !*** ./src/Public/TipsParticlesEmitter.ts ***!
  \********************************************/
/*! no static exports found */
...
var TipsParticlesEmitter =
/** @class */
function () {
  function TipsParticlesEmitter(scene, config) {
    this.lock = false; //节流锁
  ...
  TipsParticlesEmitter.prototype.init = function () {
    this.createEmitter(); //注册发射器
  };

  TipsParticlesEmitter.prototype.boom = function () {
    this.emitters.explode(40, this.tips.x, this.tips.y);
  };

  TipsParticlesEmitter.prototype.createEmitter = function () {
    //创建粒子效果发射器
  ...
  TipsParticlesEmitter.prototype.createMask = function () {
    //创建开始游戏遮罩
  ...
  TipsParticlesEmitter.prototype.playMusic = function (sourceKey) {
    //播放音频
    var mp3 = this.scene.sound.add(sourceKey);
    mp3.play();
  };

  TipsParticlesEmitter.prototype.success = function (cb) {
    var _this = this;

    if (this.lock) return;
    this.lock = true;
    this.config && this.config.renderBefore && this.config.renderBefore();
    this.tips = this.scene.add.sprite(W / 2, 208, 'glodGoodJob').setOrigin(.5).setScale(0).setDepth(2000);
    ...
    this.scene.time.addEvent({
      ...
      callback: function callback() {
        ...
        cb && cb.call(_this.scene);
      }
    });
  };

  TipsParticlesEmitter.prototype.tryAgain = function (cb) {
    var _this = this;
    ...
    this.lock = true;
    this.config && this.config.renderBefore && this.config.renderBefore();
    this.tips = this.scene.add.sprite(W / 2, 208, 'tipsTryagain').setOrigin(.5).setScale(0).setAngle(0).setDepth(2000);
    this.tryAgainBtn = this.scene.add.image(W / 2, 421, 'btnAgain').setOrigin(.5).setAlpha(0).setDepth(2001).setInteractive();
    this.createMask();
    ...
    this.scene.tweens.timeline({
      ...
      onComplete: function onComplete() {
        _this.tryAgainBtn.on('pointerdown', _this.tryAgainHandle.bind(_this, cb.bind(_this.scene)));
      }
    });
  };

  TipsParticlesEmitter.prototype.error = function (nextCb, tryagainCb) {
    var _this = this;
    ...
    this.lock = true;
    this.config && this.config.renderBefore && this.config.renderBefore();
    this.tips = this.scene.add.sprite(W / 2, 208 - H, 'tipsNo').setOrigin(.5).setDepth(2000);
    this.tryAgainBtn = this.scene.add.image(551, 364 + 20, 'btnAgainOnce').setOrigin(0).setDepth(2001).setInteractive().setAlpha(0);
    this.nextBtn = this.scene.add.image(293.5, 364 + 20, 'btnChange').setOrigin(0).setDepth(2001).setInteractive().setAlpha(0);
    this.createMask();
    this.scene.tweens.add({
      targets: this.tips,
      y: "+=" + H,
    ...
    this.scene.tweens.add({
      ...
      duration: 800,
      onComplete: function onComplete() {
        _this.tryAgainBtn.on('pointerdown', _this.tryAgainHandle.bind(_this, tryagainCb.bind(_this.scene)));

        _this.nextBtn.on('pointerdown', _this.nextHandle.bind(_this, nextCb.bind(_this.scene)));
      }
    });
  };

  TipsParticlesEmitter.prototype.nextHandle = function (cb) {
    this.playMusic('clickMp3');
    this.clearHandle();
    cb();
  };

  TipsParticlesEmitter.prototype.clearHandle = function () {
  ...
  TipsParticlesEmitter.prototype.tryAgainHandle = function (cb) {
    this.playMusic('clickMp3');
    this.clearHandle();
    cb();
  };

  TipsParticlesEmitter.loadImg = function (scene) {
  ...
  return TipsParticlesEmitter;
}();

exports["default"] = TipsParticlesEmitter;

/***/ }),

/***/ "./src/Public/jonny/components/Button.ts":
/*!***********************************************!*\
  !*** ./src/Public/jonny/components/Button.ts ***!
  \***********************************************/
/*! no static exports found */
...
var Animate_1 = __webpack_require__(/*! ../core/Animate */ "./src/Public/jonny/core/Animate.ts");
/**
 * 初始化为0.7的透明度
...
function (_super) {
  ...
  function Button(scene, x, y, texture, shape, callback) {
    if (x === void 0) {
      x = 0;
    }
    ...
    _this.bindEvent(shape, callback);

    return _this;
  }

  Button.prototype.initStyle = function () {
    this.setOrigin(0.5).setAlpha(0.7);
  };

  Button.prototype.bindEvent = function (shape, callback) {
    if (shape !== undefined) {
  ...
  Button.prototype.pointerupHandler = function () {
    if (!this.interactive) {
      return false;
    }

    Animate_1.StaticAni.alphaScaleFuc(this, 1, 1, this.minAlpha);
  ...
  Button.prototype.pointerdownHandler = function () {
    if (!this.interactive) {
      return false;
    }

    Animate_1.StaticAni.alphaScaleFuc(this, 1.2, 1.2, 1);
  ...
  Button.prototype.pointeroutHandler = function () {
    if (!this.interactive) {
      return false;
    }
  ...
  Button.prototype.pointeroverHandler = function () {
    if (!this.interactive) {
      return false;
    }

    Animate_1.StaticAni.alphaScaleFuc(this, 1, 1, 1);

    if (this.overAni) {
      Animate_1.TweenAni.alphaScaleYoyoFunc(this.scene, this, this.maxScale, this.maxScale, 1);
      this.overAni = false;
    }
...
function (_super) {
  ...
  function ButtonContainer(scene, shape, callback) {
  ...
  ButtonContainer.prototype.initStyle = function () {
    this.setAlpha(0.7);
  };

  ButtonContainer.prototype.bindEvent = function (shape, callback) {
    if (shape !== undefined) {
      this.setInteractive(shape, callback);
    } else {
      this.setInteractive();
  ...
  ButtonContainer.bindEvent = function (obj) {
    obj.on("pointerover", this.prototype.pointeroverHandler);
    obj.on("pointerout", this.prototype.pointeroutHandler);
    obj.on("pointerdown", this.prototype.pointerdownHandler);
    obj.on("pointerup", this.prototype.pointerupHandler);
  ...
  ButtonContainer.prototype.pointerupHandler = function () {
    if (!this.interactive) {
      return false;
    }
  ...
  ButtonContainer.prototype.pointerdownHandler = function () {
    if (!this.interactive) {
      return false;
    }

    Animate_1.StaticAni.alphaScaleFuc(this, this.maxScale, this.maxScale, 1);
  ...
  ButtonContainer.prototype.pointeroutHandler = function () {
    if (!this.interactive) {
      return false;
    }
  ...
  ButtonContainer.prototype.pointeroverHandler = function () {
    if (!this.interactive) {
      return false;
    }
    ...
    if (this.overAni) {
      Animate_1.TweenAni.alphaScaleYoyoFunc(this.scene, this, 1.2, 1.2, 1);
      this.overAni = false;
    }
...
/***/ "./src/Public/jonny/components/ButtonExit.ts":
/*!***************************************************!*\
  !*** ./src/Public/jonny/components/ButtonExit.ts ***!
  \***************************************************/
/*! no static exports found */
...
var Button_1 = __webpack_require__(/*! ./Button */ "./src/Public/jonny/components/Button.ts");

var core_1 = __webpack_require__(/*! ../core */ "./src/Public/jonny/core/index.ts");
/**
...
/** @class */
function (_super) {
  __extends(ButtonExit, _super);

  function ButtonExit(scene, x, y, texture, shape, callback) {
    if (x === void 0) {
      x = 25 + 60 * 0.5;
    }
    ...
    if (shape === void 0) {
      shape = new Phaser.Geom.Circle(60 * 0.5, 60 * 0.5, 60);
    }
    ...
    var _this = _super.call(this, scene, x, y, texture, shape, callback) || this;

    _this.pointerdownFunc = _this.exitGame;
    return _this;
  }

  ButtonExit.prototype.exitGame = function () {
    window.location.href = core_1.CONSTANT.INDEX_URL;
  };

  return ButtonExit;
}(Button_1.Button);

exports["default"] = ButtonExit;

/***/ }),

/***/ "./src/Public/jonny/components/ButtonMusic.ts":
/*!****************************************************!*\
  !*** ./src/Public/jonny/components/ButtonMusic.ts ***!
  \****************************************************/
/*! no static exports found */
...
function (_super) {
  ...
  function ButtonMusic(scene, x, y, texture, shape, callback) {
    if (x === void 0) {
      x = 939 + 60 * 0.5;
    }
    ...
    _this.pointerdownFunc = _this.onOffSound.bind(_this, scene);

    _this.mountUpdate = function () {
      if (_this.rotation === Math.PI * 2) {
        _this.rotation = 0;
      }
  ...
  ButtonMusic.prototype.onOffSound = function (scene) {
    var bgm = scene.bgm;
...
exports["default"] = ButtonMusic;

/***/ }),

/***/ "./src/Public/jonny/components/CoverDoublePlayer.ts":
/*!**********************************************************!*\
  !*** ./src/Public/jonny/components/CoverDoublePlayer.ts ***!
  \**********************************************************/
/*! no static exports found */
...
var CoverDoublePlayer =
/** @class */
function (_super) {
  __extends(CoverDoublePlayer, _super);

  function CoverDoublePlayer(scene, texture) {
    var _this = _super.call(this, scene, 0, 0) || this;

    _this.bg = new Phaser.GameObjects.Graphics(scene).fillStyle(0x000000).fillRect(0, 0, scene.game.renderer.width, scene.game.renderer.height).setAlpha(0.6);
    _this.image = new Phaser.GameObjects.Image(scene, scene.game.renderer.width * 0.5, scene.game.renderer.height * 0.5, texture);
    _this.text = new Phaser.GameObjects.Text(scene, 1024 * 0.5, 552 * 0.5, "等待对手进入...", {
      color: "#ffffff",
      fontSize: "30px"
    }).setOrigin(0.5).setAlpha(0);

    _this.add([_this.bg, _this.image, _this.text]);
  ...
  CoverDoublePlayer.prototype.init = function () {
    var _this = this;
  ...
  return CoverDoublePlayer;
}(Phaser.GameObjects.Container);

exports.CoverDoublePlayer = CoverDoublePlayer;

/***/ }),

/***/ "./src/Public/jonny/components/Firework.ts":
/*!*************************************************!*\
  !*** ./src/Public/jonny/components/Firework.ts ***!
  \*************************************************/
/*! no static exports found */
...
function (_super) {
  ...
  function Firework(scene) {
    var _this = _super.call(this, scene, "particleShape") || this;

    _this.emitter = _this.createEmitter({
  ...
  Firework.prototype.play = function () {
    var _this = this;
  ...
  Firework.loadImg = function (scene) {
...
/***/ "./src/Public/jonny/components/Gold.ts":
/*!*********************************************!*\
  !*** ./src/Public/jonny/components/Gold.ts ***!
  \*********************************************/
/*! no static exports found */
...
function (_super) {
  ...
  function Gold(scene, value) {
    var _this = _super.call(this, scene) || this;

    _this.value = value;
    _this.goldImg = new Phaser.GameObjects.Image(scene, 0, 0, "goldValue");
    _this.goldText = new Phaser.GameObjects.Text(scene, 0, 0, value.toString(), {
      align: "center",
      fontSize: "16px",
    ...
    _this.add([_this.goldImg, _this.goldText]);
  ...
  Gold.prototype.setText = function (value) {
    var _this = this;

    if (value < this.value) {
      var tempGoldImg_1 = new Phaser.GameObjects.Image(this.scene, 0, 0, "goldValue");
      this.add(tempGoldImg_1);
      this.scene.add.tween({
        targets: tempGoldImg_1,
        duration: 500,
        y: "+=50",
        alpha: 0,
        scale: 1.7,
...
function (_super) {
  ...
  function Particles(scene, texture, frame) {
    var _this = _super.call(this, scene, texture, frame) || this;
  ...
  Particles.prototype.boom = function (x, y, count) {
    var _this = this;
    ...
    return new Promise(function (resolve) {
      _this.emitter.explode(count, x, y);
  ...
  Particles.loadImg = function (scene) {
...
/** @class */
function () {
  function SellingGold(parentScene, config) {
    this.count = 0;
  ...
  SellingGold.prototype.goodJob = function (_goldValue) {
  ...
  SellingGold.prototype.goldAni = function () {
    var _this = this;

    var goldCoinsLight = this.golds.list[1];
    var goldCoins = this.golds.list[2];
    var goldCoinsValue = this.golds.list[3];
    var goldCoinsValueText = this.golds.list[4];

    var soundPlay = function soundPlay() {
      var sound = _this.parentScene.sound.add("goldSound");
    ...
    var ani = function ani() {
      _this.parentScene.tweens.timeline({
        tweens: [{
      ...
      _this.parentScene.add.tween({
        targets: [goldCoinsValue, goldCoinsValueText],
        scale: 1,
        ease: Animate_1.EASE.spring,
        delay: 500,
        duration: 1000
      });
      ...
      _this.parentScene.tweens.timeline({
        ...
        onComplete: function onComplete() {
          ...
          setTimeout(function () {
            _this.golds.destroy(); //晚一秒销毁的目的是为了衔接下一步的专场动画
  ...
  SellingGold.loadImg = function (scene) {
...
exports.SellingGold = SellingGold;

/***/ }),

/***/ "./src/Public/jonny/components/SuccessBtn.ts":
/*!***************************************************!*\
  !*** ./src/Public/jonny/components/SuccessBtn.ts ***!
  \***************************************************/
/*! no static exports found */
...
/** @class */
function (_super) {
  __extends(SuccessBtn, _super);

  function SuccessBtn(scene, x, y) {
    var _this = _super.call(this, scene, x, y, "successBtn") || this;

    _this.interactive = true;

    _this.init();

    _this.animate = _this.scene.add.tween({
      targets: _this,
      scale: 1.2,
      repeat: -1,
      yoyo: true,
  ...
  SuccessBtn.prototype.init = function () {
    this.setScale(0.7).setAlpha(0);
  };

  SuccessBtn.loadImg = function (scene) {
...
/***/ "./src/Public/jonny/components/TryAginListenBtn.ts":
/*!*********************************************************!*\
  !*** ./src/Public/jonny/components/TryAginListenBtn.ts ***!
  \*********************************************************/
/*! no static exports found */
...
var TryAginListenBtn =
/** @class */
function (_super) {
  __extends(TryAginListenBtn, _super);

  function TryAginListenBtn(scene, x, y) {
    var _this = _super.call(this, scene, 0, 0, "listenAgain") || this;
    ...
    _this.minAlpha = 1;
    _this.ableTips = [0, 0];
    _this.sound = _this.scene.sound.add("ClickTheButtonAndListenAgain");
  ...
  TryAginListenBtn.prototype.init = function () {
    this.setScale(0); // this.setRotation((Math.PI / 180) * -30);

    this.setAlpha(1);
  };

  TryAginListenBtn.prototype.animate = function () {
    var _this = this;
  ...
  TryAginListenBtn.prototype.checkout = function (times) {
    var _this = this;

    switch (times) {
      case 1:
        setTimeout(function () {
          if (_this.ableTips[0] === 0) {
            _this.animate();
          }
        }, 3000);
        break;
      ...
      case 2:
        setTimeout(function () {
          if (_this.ableTips[1] === 0) {
            _this.ableTips[1] = 1; //只播放一次
  ...
  TryAginListenBtn.loadAssets = function (scene) {
  ...
  return TryAginListenBtn;
}(Button_1.Button);

exports.TryAginListenBtn = TryAginListenBtn;

/***/ }),

/***/ "./src/Public/jonny/components/index.ts":
/*!**********************************************!*\
  !*** ./src/Public/jonny/components/index.ts ***!
  \**********************************************/
/*! no static exports found */
...
exports.ButtonContainer = Button_1.ButtonContainer;

var ButtonMusic_1 = __webpack_require__(/*! ./ButtonMusic */ "./src/Public/jonny/components/ButtonMusic.ts");

exports.ButtonMusic = ButtonMusic_1["default"];

var ButtonExit_1 = __webpack_require__(/*! ./ButtonExit */ "./src/Public/jonny/components/ButtonExit.ts");

exports.ButtonExit = ButtonExit_1["default"];

var SellingGold_1 = __webpack_require__(/*! ./SellingGold */ "./src/Public/jonny/components/SellingGold.ts");

exports.SellingGold = SellingGold_1.SellingGold;

var Gold_1 = __webpack_require__(/*! ./Gold */ "./src/Public/jonny/components/Gold.ts");

exports.Gold = Gold_1.Gold;

var SuccessBtn_1 = __webpack_require__(/*! ./SuccessBtn */ "./src/Public/jonny/components/SuccessBtn.ts");

exports.SuccessBtn = SuccessBtn_1.SuccessBtn;

var TryAginListenBtn_1 = __webpack_require__(/*! ./TryAginListenBtn */ "./src/Public/jonny/components/TryAginListenBtn.ts");

exports.TryAginListenBtn = TryAginListenBtn_1.TryAginListenBtn;

var Particles_1 = __webpack_require__(/*! ./Particles */ "./src/Public/jonny/components/Particles.ts");

exports.Particles = Particles_1.Particles;

var Firework_1 = __webpack_require__(/*! ./Firework */ "./src/Public/jonny/components/Firework.ts");

exports.Firework = Firework_1.Firework;

var CoverDoublePlayer_1 = __webpack_require__(/*! ./CoverDoublePlayer */ "./src/Public/jonny/components/CoverDoublePlayer.ts");

exports.CoverDoublePlayer = CoverDoublePlayer_1.CoverDoublePlayer;

/***/ }),

/***/ "./src/Public/jonny/core/Animate.ts":
/*!******************************************!*\
  !*** ./src/Public/jonny/core/Animate.ts ***!
  \******************************************/
/*! no static exports found */
...
function () {
  ...
  StaticAni.alphaScaleFuc = function (obj, _scaleX, _scaleY, _alpha) {
    obj.scaleX = _scaleX;
    obj.scaleY = _scaleY;
    obj.alpha = _alpha;
  };
...
function () {
  ...
  TweenAni.alphaScaleYoyoFunc = function (scene, obj, scaleX, scaleY, alpha) {
    scene.tweens.add({
      targets: obj,
      scaleX: scaleX,
      scaleY: scaleY,
...
exports.EASE = {
  ...
  overshoot: function overshoot(t) {
    var tension = 2.0;
    t -= 1.0;
    var result = t * t * ((tension + 1) * t + tension) + 1.0;
    return result;
  }
};
...
/***/ "./src/Public/jonny/core/IsHit.ts":
/*!****************************************!*\
  !*** ./src/Public/jonny/core/IsHit.ts ***!
  \****************************************/
/*! no static exports found */
...
exports.isHit = function (bounds1, bounds2) {
...
/***/ "./src/Public/jonny/core/arrDisorder.ts":
/*!**********************************************!*\
  !*** ./src/Public/jonny/core/arrDisorder.ts ***!
  \**********************************************/
/*! no static exports found */
...
exports.arrDisorder = function (arr) {
  var _arr = arr.map(function (v) {
    return v;
  });

  _arr = _arr.filter(function (v, i) {
    return i % 2 === 0;
  }).concat(_arr.filter(function (v, i) {
    return i % 2 !== 0;
  })).reverse().sort(function (v) {
...
/***/ "./src/Public/jonny/core/constant.ts":
/*!*******************************************!*\
  !*** ./src/Public/jonny/core/constant.ts ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/Public/jonny/core/cover.ts":
/*!****************************************!*\
  !*** ./src/Public/jonny/core/cover.ts ***!
  \****************************************/
/*! no static exports found */
...
exports.cover = function (scene, texture, callback) {
  if (callback === void 0) {
    callback = function callback() {};
  }

  var bg = scene.add.graphics().setDepth(1999);
  bg.fillStyle(0x000000);
  bg.fillRect(0, 0, scene.game.renderer.width, scene.game.renderer.height);
  bg.setAlpha(0.6);
  var image = scene.add.image(scene.game.renderer.width * 0.5, scene.game.renderer.height * 0.5, texture).setDepth(2000); //@ts-ignore
  ...
  function startHandler() {
    ...
    canvas.removeEventListener("touchstart", startHandler);
    scene.scene.resume();
    var onOff = false; //scene.scale.startFullscreen();
...
/***/ "./src/Public/jonny/core/index.ts":
/*!****************************************!*\
  !*** ./src/Public/jonny/core/index.ts ***!
  \****************************************/
/*! no static exports found */
...
var cover_1 = __webpack_require__(/*! ./cover */ "./src/Public/jonny/core/cover.ts");

exports.cover = cover_1.cover;

var resize_1 = __webpack_require__(/*! ./resize */ "./src/Public/jonny/core/resize.ts");

exports.resize = resize_1.resize;

var rotateTips_1 = __webpack_require__(/*! ./rotateTips */ "./src/Public/jonny/core/rotateTips.ts");

exports.rotateTips = rotateTips_1.rotateTips;

var IsHit_1 = __webpack_require__(/*! ./IsHit */ "./src/Public/jonny/core/IsHit.ts");

exports.Bounds = IsHit_1.Bounds;
exports.isHit = IsHit_1.isHit;

var Math_1 = __webpack_require__(/*! ./Math */ "./src/Public/jonny/core/Math.ts");

exports.Vec2 = Math_1.Vec2;

var constant_1 = __webpack_require__(/*! ./constant */ "./src/Public/jonny/core/constant.ts");

exports.CONSTANT = constant_1.CONSTANT;

var Animate_1 = __webpack_require__(/*! ./Animate */ "./src/Public/jonny/core/Animate.ts");

exports.EASE = Animate_1.EASE;
exports.StaticAni = Animate_1.StaticAni;
exports.TweenAni = Animate_1.TweenAni;

var arrDisorder_1 = __webpack_require__(/*! ./arrDisorder */ "./src/Public/jonny/core/arrDisorder.ts");

exports.arrDisorder = arrDisorder_1.arrDisorder;

/***/ }),

/***/ "./src/Public/jonny/core/resize.ts":
/*!*****************************************!*\
  !*** ./src/Public/jonny/core/resize.ts ***!
  \*****************************************/
/*! no static exports found */
...
function deleteOther() {
  ...
  var dontRemove = document.querySelector(".dontRemove");
  dontRemove.innerHTML = "";
}

/***/ }),

/***/ "./src/Public/jonny/core/rotateTips.ts":
/*!*********************************************!*\
  !*** ./src/Public/jonny/core/rotateTips.ts ***!
  \*********************************************/
/*! no static exports found */
...
exports.rotateTips = {
  ...
  createElement: function createElement(tag, id, className, src, innerHTML) {
    if (id === void 0) {
      id = "";
    }
  ...
  landscape: function landscape() {
    ...
    console.log(this.orientationState);
    var rotateTips = document.querySelector("#rotateTips");
...
/***/ "./src/Public/jonny/selectTopic/Answer.ts":
/*!************************************************!*\
  !*** ./src/Public/jonny/selectTopic/Answer.ts ***!
  \************************************************/
/*! no static exports found */
...
var Math_1 = __webpack_require__(/*! ../core/Math */ "./src/Public/jonny/core/Math.ts");

exports.serial = ["A", "B", "C", "D"];
exports.position4 = [new Math_1.Vec2(130, 322 + 204 * 0.5), new Math_1.Vec2(388, 322 + 204 * 0.5), new Math_1.Vec2(642, 322 + 204 * 0.5), new Math_1.Vec2(896, 322 + 204 * 0.5)];
exports.position3 = [new Math_1.Vec2(256 - 15, 322 + 204 * 0.5), new Math_1.Vec2(512, 322 + 204 * 0.5), new Math_1.Vec2(768 + 15, 322 + 204 * 0.5)];
...
function (_super) {
  ...
  function Answer(scene, config) {
    var _this = _super.call(this, scene, config.position.x, config.position.y) || this;

    _this.interactive = true;
    _this.bg = new Phaser.GameObjects.Image(scene, 0, 0, config.bgTexture);
    _this.answerContent = new Phaser.GameObjects.Text(scene, 0, 30, config.answerContent, {
      align: "center",
      fontFamily: "Helvetica",
      color: "#ffffff",
      fontSize: 30 - config.answerContent.length * 0.4 + "px",
      wordWrap: {
        width: _this.bg.width * 0.6
      },
      resolution: 2
    }).setOrigin(0.5); //this.serial = new Phaser.GameObjects.BitmapText(scene, config.serial.position.x, config.serial.position.y, "", config.serial.value, 30, 1).setOrigin(0.5);

    _this.serial = new Phaser.GameObjects.Text(scene, config.serial.position.x, config.serial.position.y, config.serial.value, {
      align: "center",
      fontFamily: "Helvetica",
      color: "#ffffff",
      fontSize: "25px",
    ...
    _this.shape = new Phaser.Geom.Circle(0, 0, _this.bg.width * 0.4);
    _this.name = config.answerContent;
    _this.isRight = config.isRight;
    _this.initPosition = {
      x: _this.x,
      y: _this.y
    };

    _this.add([_this.bg, _this.serial, _this.answerContent]);

    _this.setInteractive(_this.shape, Phaser.Geom.Circle.Contains);

    return _this; //this.drawHitArea();
  }

  Answer.prototype.drawHitArea = function () {
    var graphics = new Phaser.GameObjects.Graphics(this.scene).lineStyle(2, 0xff0000, 1).strokeCircleShape(this.shape);
    this.add(graphics);
  };

  Answer.prototype.bounceAni = function () {
    var _this = this;
  ...
  Answer.prototype.shakingAni = function () {
    var _this = this;
    ...
    return new Promise(function (resolve) {
      ...
      _this.scene.add.tween({
        ...
        ease: "Sine.easeInOut",
        onComplete: function onComplete() {
          _this.setPosition(_this.initPosition.x, _this.initPosition.y);
...
/***/ "./src/Public/jonny/selectTopic/CivaWorker.ts":
/*!****************************************************!*\
  !*** ./src/Public/jonny/selectTopic/CivaWorker.ts ***!
  \****************************************************/
/*! no static exports found */
...
/** @class */
function (_super) {
  __extends(CivaWorker, _super);

  function CivaWorker(scene, x, y, texture, frame) {
  ...
  CivaWorker.prototype.asWizard = function () {
    this.scene.anims.create({
      key: "fly",
      frames: this.scene.anims.generateFrameNames("wizard", {
        prefix: "Wizard00",
        start: 0,
        end: 14
      }),
  ...
  CivaWorker.prototype.staticLeave = function (offsetX) {
    this.x += offsetX;
    return this;
  };
  /**
  ...
  CivaWorker.prototype.admission = function () {
    var _this = this;
  ...
  CivaWorker.prototype.asBee = function () {
    this.scene.anims.create({
      key: "flight",
      frames: this.scene.anims.generateFrameNames("civaBee", {
        prefix: "civaBee000",
        start: 0,
        end: 1
      }),
  ...
  CivaWorker.prototype.asBeeDance = function () {
    var _this = this;
  ...
  CivaWorker.prototype.asBeeWorking = function (x, y) {
    var _this = this;
    ...
    return new Promise(function (resolve) {
      _this.scene.tweens.timeline({
        ...
        tweens: [{
          ...
          onUpdate: function onUpdate() {
            _this.time += 0.1;
            _this.x += Math.sin(_this.time) * 10;
          }
        }],
        onComplete: function onComplete() {
          _this.anims.stop();
  ...
  CivaWorker.prototype.isRight = function () {
    this.scene.add.tween({
      targets: this,
      scale: 1.5,
      alpha: 0.5,
  ...
  */
  ...
  CivaWorker.prototype.isWrong = function () {
    this.scene.add.tween({
      targets: this,
      scale: 0.5,
      alpha: 0,
  ...
  CivaWorker.prototype.leave = function () {
    var _this = this;

    return new Promise(function (resolve) {
      var offsetX;

      if (_this.initVec2.x > 1024 * 0.5) {
        offsetX = _this.initVec2.x += 400;
      } else {
        offsetX = _this.initVec2.x -= 400;
      }
...
exports.CivaWorker = CivaWorker;

/***/ }),

/***/ "./src/Public/jonny/selectTopic/Topic.ts":
/*!***********************************************!*\
  !*** ./src/Public/jonny/selectTopic/Topic.ts ***!
  \***********************************************/
/*! no static exports found */
...
function (_super) {
  ...
  function Topic(scene, questionContent) {
    var _this = _super.call(this, scene, 72 + 880 * 0.5, 68 + 160 * 0.5) || this;

    _this.bg = new Phaser.GameObjects.Image(scene, 0, 0, "tigan");
    _this.question = new Phaser.GameObjects.Text(scene, 0, 10, questionContent, {
      align: "center",
      fontFamily: "Helvetica",
      color: "#FF6E09",
      fontSize: "30px",
    ...
    _this.add([_this.bg, _this.question]);
...
/***/ "./src/Public/jonny/selectTopic/index.ts":
/*!***********************************************!*\
  !*** ./src/Public/jonny/selectTopic/index.ts ***!
  \***********************************************/
/*! no static exports found */
...
var Topic_1 = __webpack_require__(/*! ./Topic */ "./src/Public/jonny/selectTopic/Topic.ts");

exports.Topic = Topic_1.Topic;

var Answer_1 = __webpack_require__(/*! ./Answer */ "./src/Public/jonny/selectTopic/Answer.ts");

exports.Answer = Answer_1.Answer;
exports.position3 = Answer_1.position3;
exports.position4 = Answer_1.position4;
exports.serial = Answer_1.serial;

var CivaWorker_1 = __webpack_require__(/*! ./CivaWorker */ "./src/Public/jonny/selectTopic/CivaWorker.ts");

exports.CivaWorker = CivaWorker_1.CivaWorker;
...
exports["default"] = {
   ...
   */
  getQuestionData: function getQuestionData(bookId, unitId) {
...
var lastNoticeTime = 0; // 上次提醒时间标记，防止连续提醒

var _fetch = function _fetch(url, options) {
  var reqTimeoutHash = +new Date() + '' + Math.random();
  var netWeakWait = 5 * 1000; // 超时等待时间

  _fetch[reqTimeoutHash] = true; // 超时提醒，提醒间隔为超时等待时间, POST 等待时间为 GET 请求的 2 倍

  setTimeout(function () {
    var nowTime = +new Date();
    if (!_fetch[reqTimeoutHash]) return;
    delete _fetch[reqTimeoutHash];
    var showNotice = nowTime - lastNoticeTime > netWeakWait; //@ts-ignore

    showNotice && (window.toast || alert)('您的网络不给力哦！');
    lastNoticeTime = showNotice ? nowTime : lastNoticeTime; //@ts-ignore
  }, netWeakWait * (options.method == 'POST' ? 2 : 1)); //@ts-ignore
...
var jsonParse = function jsonParse(res) {
  //@ts-ignore  
...
function get(url, type) {
  ...
  if (type == 'json') return _res.then(jsonParse);
  if (type == 'text') return _res.then(function (res) {
    return res.text();
  });
  return _res;
}

exports.get = get; // post 请求，默认使用 form 提交，默认使用 json 解析

function post(url, data, type, withForm) {
  if (type === void 0) {
    type = 'json';
  }
...
__webpack_require__(/*! phaser */ "./node_modules/phaser/src/phaser.js");
/**
 * example ?game=0&scrren=1&physics=0
 */
...
console.log(initData.screen.value[initData.screen.index].width, initData.screen.value[initData.screen.index].height);
var config = {
  type: Phaser.AUTO,
  width: initData.screen.value[initData.screen.index].width,
  height: initData.screen.value[initData.screen.index].height,
  parent: 'content',
  scale: {
  ...
  physics: {
    "default": initData.physics.value[initData.physics.index],
    arcade: {
      gravity: {
        y: 0
      },
...
/** @class */
function (_super) {
  __extends(JonnyGames, _super);

  function JonnyGames(config) {
...
var dynamicLoading = function dynamicLoading(game) {
  var keys = __webpack_require__("./src/scenes sync recursive \\.ts$").keys();

  keys = keys.filter(function (key) {
    return new RegExp(game).test(key);
  }).map(function (key) {
    return key.replace(/\.\//, "");
  });
  Promise.all(keys.map(function (key) {
    return Promise.resolve().then(function () {
      return __webpack_require__("./src/scenes sync recursive ^\\.\\/.*$")("./" + key);
    }).then(function (v) {
      config.scene.push(v["default"]);
    });
  })).then(function () {
    window.onload = function () {
      var jonnyGame = new JonnyGames(config);
    };
  });
};

dynamicLoading(initData.game.value[initData.game.index]);

/***/ }),

/***/ "./src/scenes sync recursive \\.ts$":
/*!*******************************!*\
  !*** ./src/scenes sync \.ts$ ***!
  \*******************************/
/*! no static exports found */
...
var map = {
	"./Game0/Load.ts": "./src/scenes/Game0/Load.ts",
	"./Game0/Play.ts": "./src/scenes/Game0/Play.ts"
};
...
webpackContext.id = "./src/scenes sync recursive \\.ts$";

/***/ }),

/***/ "./src/scenes sync recursive ^\\.\\/.*$":
/*!**********************************!*\
  !*** ./src/scenes sync ^\.\/.*$ ***!
  \**********************************/
/*! no static exports found */
...
var map = {
	"./Game0/Load": "./src/scenes/Game0/Load.ts",
	"./Game0/Load.ts": "./src/scenes/Game0/Load.ts",
	"./Game0/Play": "./src/scenes/Game0/Play.ts",
	"./Game0/Play.ts": "./src/scenes/Game0/Play.ts"
};
...
webpackContext.resolve = webpackContextResolve;
module.exports = webpackContext;
webpackContext.id = "./src/scenes sync recursive ^\\.\\/.*$";

/***/ }),

/***/ "./src/scenes/Game0/Load.ts":
/*!**********************************!*\
  !*** ./src/scenes/Game0/Load.ts ***!
  \**********************************/
/*! no static exports found */
...
var apiPath_1 = __webpack_require__(/*! ../../lib/apiPath */ "./src/lib/apiPath.ts");

var http_1 = __webpack_require__(/*! ../../lib/http */ "./src/lib/http.ts");

var core_1 = __webpack_require__(/*! ../../Public/jonny/core */ "./src/Public/jonny/core/index.ts");

var components_1 = __webpack_require__(/*! ../../Public/jonny/components */ "./src/Public/jonny/components/index.ts");

var selectTopic_1 = __webpack_require__(/*! ../../Public/jonny/selectTopic */ "./src/Public/jonny/selectTopic/index.ts");

var TipsParticlesEmitter_1 = __webpack_require__(/*! ../../Public/TipsParticlesEmitter */ "./src/Public/TipsParticlesEmitter.ts");
...
/** @class */
function (_super) {
  __extends(Game0LoadScene, _super);

  function Game0LoadScene() {
     ...
     */
    {
      "url": "assets/mask/Game0.png",
      "key": "Game0"
    }, {
      "url": "assets/commonUI/successBtn.png",
      "key": "successBtn"
    }, {
      "url": "assets/commonUI/btnSoundOff.png",
      "key": "btnSoundOff"
    }, {
      "url": "assets/commonUI/btnSoundOn.png",
      "key": "btnSoundOn"
    }, {
      "url": "assets/commonUI/btnExit.png",
      "key": "btnExit"
    }, {
      "url": "assets/commonUI/goldValue.png",
      "key": "goldValue"
    }, {
      "url": "assets/commonUI/tipsArrowUp.png",
      "key": "tipsArrowUp"
    }
    /**
     * game15 UI
     */
    , {
      "url": "assets/Game0/bg.png",
      "key": "bg"
    }, {
      "url": "assets/Game0/daan01.png",
      "key": "daan"
    }, {
      "url": "assets/Game0/tigan01.png",
      "key": "tigan"
    }, {
      "url": "assets/Game0/tigan01.png",
      "key": "tigan"
  ...
  Game0LoadScene.prototype.init = function () {
    core_1.resize.call(this, W, H);
  ...
  Game0LoadScene.prototype.preload = function () {
    var _this = this;
    ...
    this.load.atlas("civaBee", "assets/Game0/civaBee.png", "assets/Game0/civaBee.json");
    ...
    TipsParticlesEmitter_1["default"].loadImg(this);
    components_1.TryAginListenBtn.loadAssets(this);
    components_1.SellingGold.loadImg(this);
    this.assets.forEach(function (v) {
      _this.load.image(v.key, v.url);
    });
    this.load.on("progress", function (e) {
      e = Math.floor(e * 100);

      _this.centerText.setText(e + "%");
    });
  };
  /**
   * 获取网络资源
  ...
  Game0LoadScene.prototype.getData = function () {
    var _this = this;

    return http_1.get(apiPath_1["default"].getQuestionData("c737587a-34ce-47d5-b5c0-6db031712c07", "aaeacf2b-bc61-4135-a976-aa1b6815eeaf")).then(function (res) {
      if (res.code === '0000') {
        _this.ccData = res.result;
        window.localStorage.setItem("ccData", JSON.stringify(res.result));
      } else if (res.code === "999999999") {
        _this.ccData = JSON.parse(window.localStorage.getItem("ccData"));
      }
    }).then(function () {
      _this.ccData = _this.ccData.filter(function (v, i) {
        return i < 10;
      }).map(function (v) {
        delete v.audiokey;
        delete v.imgKey;
        v.questionContent = v.questionContent.replace(/\d+\./, "").replace(/[\?\？]\s*/, "?\n").replace(/^[-—]+/, "").replace(/\s{2,}/, " ").replace(/\?_+/, "?\n").replace(/\n$/, "").replace(/^\s/, "").replace(/\?\s*[—-]+/, "?\n").replace(/\n\s+/, "\n").replace(/&nbsp;/, "").replace(/_+/, "___").replace(/’/, "'");
        v.answers.forEach(function (_v, _i) {
          delete _v.audioKey;
          delete _v.imgKey;
          _v.answerContent = _v.answerContent.replace(/[;；]/, ";\n");
          _v.position = v.answers.length === 4 ? selectTopic_1.position4[_i] : selectTopic_1.position3[_i];
          _v.bgTexture = "daan02";
          _v.serial = {
            value: selectTopic_1.serial[_i],
            position: {
              x: 4,
              y: 74
            }
  ...
  Game0LoadScene.prototype.create = function () {
          ...
          case 1:
            ...
            control = {
              ...
              bindEvent: function bindEvent() {
                control.commit.addEventListener("click", function () {
              ...
              nextScene: function nextScene() {
                ...
                _this.scene.start("Game0PlayScene", {
                  data: _this.ccData,
                  index: 0,
  ...
  return Game0LoadScene;
}(Phaser.Scene);

exports["default"] = Game0LoadScene;
;

/***/ }),

/***/ "./src/scenes/Game0/Play.ts":
/*!**********************************!*\
  !*** ./src/scenes/Game0/Play.ts ***!
  \**********************************/
/*! no static exports found */
...
/** @class */
function (_super) {
  __extends(Game0PlayScene, _super);

  function Game0PlayScene() {
    var _this = _super.call(this, {
      key: "Game0PlayScene"
    }) || this; //数据层
    ...
    _this.answers = [];
    _this.prevAnswer = null;
    return _this;
  }

  Game0PlayScene.prototype.init = function (res) {
    index = res.index;
    this.ccData = res.data;
    this.myNameValue = res.name; //console.log(res);
  };

  Game0PlayScene.prototype.preload = function () {};

  Game0PlayScene.prototype.create = function () {
    this.createStage();
    this.createActors();

    if (index === 0) {
      this.scene.pause();
      core_1.rotateTips.init();
      this.firstCreate(); // cover(this, "Game0", () => {
      //   this.gameStart();
      // });
  ...
  Game0PlayScene.prototype.update = function (time, delta) {
  ...
  Game0PlayScene.prototype.firstCreate = function () {
  ...
  Game0PlayScene.prototype.createObservable = function () {
    var _this = this;

    this.socket$.subscribe(function (res) {
  ...
  Game0PlayScene.prototype.createSocket = function () {
    var that = this; //console.log(th.name);

    that.socket = io.connect("http://www.jonnypeng.com:4003");
    that.socket.emit("hello", {
      name: that.myNameValue
    });
    that.socket.on("waiting", function (value) {
      value.event = "waiting";
      that.socket$.next(value);
    });
    that.socket.on("join", function (value) {
      value.event = "join";
      that.socket$.next(value);
    });
    that.socket.on("start", function (value) {
      value.event = "start";
      that.socket$.next(value);
    });
    that.socket.on("herRight", function (value) {
      value.event = "herRight";
      console.log(value);
      that.socket$.next(value);
    });
    that.socket.on("herWrong", function (value) {
      value.event = "herWrong";
      that.socket$.next(value);
    });
    that.socket.on("leave", function (value) {
      value.event = "leave";
      that.socket$.next(value);
    });
    that.socket.on("absence", function (value) {
      value.event = "absence";
      that.socket$.next(value);
    });
  };
  ...
  Game0PlayScene.prototype.createStage = function () {
    var that = this;
    ...
    this.cover = new components_1.CoverDoublePlayer(this, "Game0");
    this.cover.alpha = index === 0 ? 1 : 0;
    this.btnExit = new components_1.ButtonExit(this);
    this.btnSound = new components_1.ButtonMusic(this);
  ...
  Game0PlayScene.prototype.audioPlay = function (key) {
    var _this = this;

    return new Promise(function (resolve) {
      var _tempSound = _this.sound.add(key);

      _tempSound.on("complete", function () {
        this.destroy();
        resolve(1);
      });
  ...
  Game0PlayScene.prototype.createActors = function () {
    var _this = this; //创建用户反馈


    this.tipsParticlesEmitter = new TipsParticlesEmitter_1["default"](this); //创建题板

    this.topic = new selectTopic_1.Topic(this, this.ccData[index].questionContent);
    this.topic.alpha = index === 0 ? 0 : 1;
    this.ccData[index].answers.forEach(function (answer) {
      var _answer = new selectTopic_1.Answer(_this, {
        position: {
          x: answer.position.x,
          y: answer.position.y
        },
    ...
    this.mouth.on("animationcomplete", function () {
      _this.mouth.visible = false;
    });
    this.civaBee = new selectTopic_1.CivaWorker(this, 150, 34.5 + 116 * 0.5, "civaBee").setDepth(4).asBee().staticLeave(-400);
    this.civaWizard = new selectTopic_1.CivaWorker(this, 1024 - 150, 34.5 + 116 * 0.5, "civaBee").setDepth(4).asBee().staticLeave(400);
    ...
    this.add.existing(this.civaWizard); //goldValue = window.sessionStorage.getItem("goldValue") !== null ? JSON.parse(window.sessionStorage.getItem("goldValue")) : goldValue;

    console.log(goldValue);
    this.beeGold = new components_1.Gold(this, goldValue.bee); //设置金币

    this.wizardGold = new components_1.Gold(this, goldValue.wizard);
    ...
    this.layer4.addAt([this.beeGold, this.wizardGold, this.cover], 0); // this.beeGold.alpha = this.civaBee.alpha = this.career === "bee" ? 1 : 0.5;
  ...
  Game0PlayScene.prototype.createMyName = function (name) {
    this.myName = new Phaser.GameObjects.Text(this, this[this.career + "Gold"].x, this[this.career + "Gold"].y + 50, name, {
      color: "#ff7f3a",
      align: "center"
    }).setOrigin(0.5);
  ...
  Game0PlayScene.prototype.createHerName = function (name) {
    var herCareer = this.career === "bee" ? "wizard" : "bee";
    this.herName = new Phaser.GameObjects.Text(this, this[herCareer + "Gold"].x, this[herCareer + "Gold"].y + 50, name, {
      color: "#ff7f3a",
      align: "center"
    }).setOrigin(0.5);
  ...
  Game0PlayScene.prototype.gameStart = function () {
    var _this = this;
    ...
    var ready = function ready() {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          this.answers.forEach(function (answer) {
            answer.on("pointerdown", _this.touchAnswer.bind(_this, answer));
          });
          return [2
          /*return*/
          ];
  ...
  Game0PlayScene.prototype.resetCivaScale = function () {
  ...
  Game0PlayScene.prototype.touchAnswer = function (answer) {
    if (!answer.interactive) {
      return false;
    }

    this.answers.forEach(function (_answer) {
  ...
  Game0PlayScene.prototype.moveTo = function (obj, x, y, duration, callback) {
    if (duration === void 0) {
      duration = 500;
    }
  ...
  Game0PlayScene.prototype.testEnd = function () {
    var _this = this;

    this.checkoutResult().subscribe(function (value) {
      if (value) {
        _this.isRight();
      } else {
        _this.isWrong();
  ...
  Game0PlayScene.prototype.isRight = function () {
    var _this = this;

    var nextFuc = function nextFuc() {
      _this.sellingGold = new components_1.SellingGold(_this, {
        callback: function callback() {
          _this.sellingGold.golds.destroy();

          _this.setGoldValue(_this.career, 3);

          _this.socket.emit("isRight", {
            num: _this.num,
            career: _this.career,
            goldValue: goldValue[_this.career]
          });
      ...
      _this.sellingGold.golds.setDepth(6);

      _this.tipsParticlesEmitter.success(function () {
        _this.sellingGold.goodJob(3);
      });
    };
  ...
  Game0PlayScene.prototype.isWrong = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  Game0PlayScene.prototype.tryAgin = function () {
  ...
  Game0PlayScene.prototype.resetStart = function () {
    this.answers.forEach(function (answer) {
  ...
  Game0PlayScene.prototype.ohNo = function () {
    var _this = this;

    this.setGoldValue(this.career, -1);
    this.socket.emit("isWrong", {
      num: this.num,
      career: this.career,
      goldValue: goldValue[this.career]
    });
    this.tipsParticlesEmitter.error(this.nextRound, this.resetStart);
  ...
  Game0PlayScene.prototype.nextRound = function () {
    index += 1; //index = 7; //test
    ...
    this.times = 0;
    this.scene.start('Game0PlayScene', {
      data: this.ccData,
      index: index,
  ...
  Game0PlayScene.prototype.checkoutResult = function () {
    console.log(this.prevAnswer);
    var isRightValue = this.prevAnswer.isRight;
  ...
  Game0PlayScene.prototype.setGoldValue = function (career, value) {
  ...
  Game0PlayScene.prototype.checkoutGoldValue = function () {
    return goldValue[this.career] < 0 ? true : false;
  };

  return Game0PlayScene;
}(Phaser.Scene);

exports["default"] = Game0PlayScene;
...
module.exports = __webpack_require__(/*! /Users/jonny/IMPORTANT/html/projects/jonnyGames/src/main.ts */"./src/main.ts");
